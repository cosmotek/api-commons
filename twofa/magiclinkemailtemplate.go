...
<div style="margin:0px auto;max-width:640px;background:transparent;"><table role="presentation" cellpadding="0" cellspacing="0" style="font-size:0px;width:100%;background:transparent;" align="center" border="0"><tbody><tr><td style="text-align:center;vertical-align:top;direction:ltr;font-size:0px;padding:40px 0px;"><!--[if mso | IE]>
      ...
      <![endif]--><div aria-labelledby="mj-column-per-100" class="mj-column-per-100 outlook-group-fix" style="vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:100%;"><table role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0"><tbody><tr><td style="word-break:break-word;font-size:0px;padding:0px;" align="center"><table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:collapse;border-spacing:0px;" align="center" border="0"><tbody><tr><td style="width:auto;"><a href="https://ivueit.com/" target="_blank"><img alt="" title="" height="38px" src="https://iv3.nyc3.cdn.digitaloceanspaces.com/public_assets/ivueit_gray_logo.png" style="border:none;border-radius:;display:block;outline:none;text-decoration:none;width:100%;height:38px;" width="138"></a></td></tr></tbody></table></td></tr></tbody></table></div><!--[if mso | IE]>
      </td></tr></table>
      ...
      <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="640" align="center" style="width:640px;">
        <tr>
          <td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;">
      <![endif]--><div style="max-width:640px;margin:0 auto;box-shadow:0px 1px 5px rgba(0,0,0,0.1);border-radius:4px;overflow:hidden"><div style="margin:0px auto;max-width:640px;background:#7289DA url(https://iv3.nyc3.cdn.digitaloceanspaces.com/public_assets/ivueit_gray_logo.png) top center / cover no-repeat;"><!--[if mso | IE]>
      <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width:640px;">
        <v:fill origin="0.5, 0" position="0.5,0" type="tile" src="https://iv3.nyc3.cdn.digitaloceanspaces.com/public_assets/ivueit_gray_logo.png" />
      ...
      <![endif]--><div style="cursor:auto;color:white;font-family:Whitney, Helvetica Neue, Helvetica, Arial, Lucida Grande, sans-serif;font-size:36px;font-weight:600;line-height:36px;text-align:center;">{{.Header}}</div><!--[if mso | IE]>
      </td></tr></table>
  ...
  {{end}}
          ...
          </div></td></tr><tr><td style="word-break:break-word;font-size:0px;padding:10px 25px;" align="center"><table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:separate;" align="center" border="0"><tbody><tr><td style="border:none;border-radius:3px;color:white;cursor:auto;padding:15px 19px;" align="center" valign="middle" bgcolor="#6bc064"><a href="{{.ButtonURL}}" style="text-decoration:none;line-height:100%;background:#6bc064;color:white;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:15px;font-weight:normal;text-transform:none;margin:0px;" target="_blank">
            {{.ButtonLabel}}
      ...
      Sent by iVueit • <a href="https://ivueit.com/blog" style="color:#1EB0F4;text-decoration:none;" target="https://ivueit.com/blog">check our blog</a> • <a href="https://twitter.com/ivueitapp?lang=en" style="color:#1EB0F4;text-decoration:none;" target="https://twitter.com/ivueitapp?lang=en">@ivueitapp</a>
...
// init is called on package load, which in this case parses the template
// for later use. This avoids the repeat work of parsing the template on demand.
func init() {
	var err error
	tmpl, err = template.New("magiclink").Parse(magicLinkEmailTemplate)
	if err != nil {
		panic(err)
	}
}

// MagicLinkEmailParams is used to store template data
// for template execution (required by the template library).
type MagicLinkEmailParams struct {
	Header      string
	Messages    []string
	ButtonURL   string
	ButtonLabel string
...
// GenerateMagicLinkEmailHTML generates an HTML email from template using
// provided recipient/sender information returning the HTML string.
func GenerateMagicLinkEmailHTML(templateData MagicLinkEmailParams) (string, error) {
